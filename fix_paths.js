...
// Replace /assets/uploads/YYYY/MM/filename with /assets/images/filename
content = content.replace(/\/assets\/uploads\/\d{4}\/\d{2}\/([^\/\"']+)/g, '/assets/images/');
...
// And Base64 versions like: \/assets\/uploads\/...
