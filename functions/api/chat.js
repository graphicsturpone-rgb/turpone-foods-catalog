...
CRITICAL INSTRUCTION: You must detect the language of the user's message and reply in the EXACT SAME LANGUAGE (English, Spanish, or French).`;
        ...
        if (body.context && body.context.url) {
            systemInstruction += `\n\nCONTEXT NOTE: The user is currently browsing the page titled "${body.context.title}" at the URL: ${body.context.url}. Use this context to understand what product or section they are looking at if they ask questions like "How much is this?" or "What are the ingredients of this product?".`;
        }
